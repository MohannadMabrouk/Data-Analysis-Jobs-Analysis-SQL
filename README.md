# Introduction
Dive into the data job market! Focusinf on data analyst roles, this project explores top-paying jobs, in-demand skills, and where high demands meets high salary in data analytics.
...
3. What are the most in_demand skills for data analyst?
4. What are the top skills based on salary?
5. What are the most optimal skills to learn?
# Tools Used
For this data analysis job market, I made use of this key tools:

- **SQL:** Allowed me to query the database and generate critical insights.
- **PostgreSQL:** The chosen database management system (DBMS), ideal for handling the job posting data.
...
| Job ID   | Job Title                                 | Job Location | Schedule Type | Salary (Yearly Avg) | Posted Date           | Name                                  |
|----------|-------------------------------------------|--------------|---------------|---------------------|-----------------------|---------------------------------------|
...
Throughout this project, I've boosted my SQL toolkit with some serious firepower:
